...
type LegacyHeaders struct {
	...
	PassUserHeaders   bool `flag:"pass-user-headers" cfg:"pass_user_headers"` //Includes  X-Forwarded-User, X-Forwarded-Groups, X-Forwarded-Email and X-Forwarded-Preferred-Username
...
func legacyHeadersFlagSet() *pflag.FlagSet {
	...
	flagSet.Bool("pass-user-headers", true, "pass X-Forwarded-User, X-Forwarded-Groups  and X-Forwarded-Email information to upstream")
